...
export class Migrations1713251351422 implements MigrationInterface {
    name = 'Migrations1713251351422'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE \`user\` (
                ...
                \`role_id\` tinyint UNSIGNED ('1', '2') NOT NULL DEFAULT '2',
        ...
        await queryRunner.query(`
            ...
            ADD CONSTRAINT \`FK_0248d0e8d737351620b03c3cfca\` FOREIGN KEY (\`permission_group_id\`) REFERENCES \`permission_group\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            DROP TABLE \`notification_member\`
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            DROP TABLE \`language_key\`
        `);
        await queryRunner.query(`
            DROP TABLE \`language_env\`
        `);
        await queryRunner.query(`
            DROP TABLE \`language\`
        `);
